...
2. **Trabajadores** → cada persona con sus datos de contrato (DNI, IBAN, relación laboral, tarifa €/h) y sus documentos; desde su ficha se genera su factura (autónomos) o recibo de horas (contrato) de cada mes. Los datos personales solo los ve dirección. Su pestaña **Asistencia** lleva el control del absentismo: detección automática de días con trabajo asignado y sin fichaje, justificantes adjuntos, e **informe de absentismo** con gráficas y análisis automático (en Informes). El fichaje exige **foto de entrada y de salida** como confirmación (se puede desactivar en Ajustes).
